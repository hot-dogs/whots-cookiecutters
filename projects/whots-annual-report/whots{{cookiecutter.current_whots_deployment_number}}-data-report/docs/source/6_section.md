...
During the WHOTS-{{cookiecutter.current_whots_deployment_number}} cruise (WHOTS-{{cookiecutter.current_whots_deployment_number}} mooring deployment, {{cookiecutter.current_whots_deployment_date}}), a
...
During the WHOTS-{{cookiecutter.next_whots_deployment}} cruise (WHOTS-{{cookiecutter.current_whots_deployment_number}} mooring recovery, {{cookiecutter.next_whots_deployment_date}}), a high-pressure ridge far north of the Hawaiian Islands maintained a
...
{numref}`w1_{{cookiecutter.current_whots_deployment_number}}_contTS.png` through {numref}`w1_{{cookiecutter.current_whots_deployment_number}}_cont_S.png` show contours of
...
```{figure} figures/ctd/2.whots_{{cookiecutter.next_whots_deployment}}/s2c1_s20c1.png
:height: 800px
:align: center
:name: figure6.6
...
```{figure} figures/ctd/2.whots_{{cookiecutter.next_whots_deployment}}/s50c1_s50c2.png
:height: 1000px
:align: center
:name: figure6.7
...
```{figure} figures/ctd/2.whots_{{cookiecutter.next_whots_deployment}}/s50c3_s50c4.png
:height: 1000px
:align: center
:name: figure6.8
...
```{figure} figures/ctd/2.whots_{{cookiecutter.next_whots_deployment}}/s50c5_s50c6.png
:height: 1000px
:align: center
:name: figure6.9
...
```{figure} figures/ctd/2.whots_{{cookiecutter.next_whots_deployment}}/s52c1_s52c2.png
:height: 1000px
:align: center
:name: figure6.10
...
```{figure} figures/microcats/w1_{{cookiecutter.current_whots_deployment_number}}_cont_S.png
:height: 1000px
:align: center
...
```{figure} figures/shipboard_adcp/whots{{cookiecutter.current_whots_deployment_number}}deploy_adcp_contour2.png
:width: 1000px
:align: center
...
```{figure} figures/adcp_moored/wh{{cookiecutter.current_whots_deployment_number}}_moor_ship_ADCP_comp_3.png
:width: 1000px
:align: center
...
```{figure} figures/adcp_moored/wh{{cookiecutter.current_whots_deployment_number}}gps_spec_dpng.png
:width: 1000px
:align: center
